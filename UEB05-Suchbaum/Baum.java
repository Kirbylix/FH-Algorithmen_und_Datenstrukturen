...
// Methoden zum Suchen
	...
	private boolean suchenKnoten(T daten, Knoten<T> teilbaum)
	{
		if (teilbaum == null)
			return false;
...
// Methoden zum Einfügen
	...
	private void einfuegenKnoten(T daten, Knoten<T> teilbaum)
	{
		// Vergleichs-Ergebnis zwischenspeichern, da compareTo()
		// aufwändig sein kann, und das Ergebnis mehrfach benötigt
		// wird
...
// Methoden zum Entfernen
	...
	public void entfernen(T daten)
	{
		...
		// aufwändig sein kann, und das Ergebnis mehrfach benötigt
		// wird
		int cmp = daten.compareTo(wurzel.getDaten());
	...
	private void entfernenKnoten(T daten, Knoten<T> elternknoten, Knoten<T> teilbaum, boolean linkerTeilbaum)
	{
		// Vergleichs-Ergebnis zwischenspeichern, da compareTo()
		// aufwändig sein kann, und das Ergebnis mehrfach benötigt
		// wird
